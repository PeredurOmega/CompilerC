...
public:
    ...
    enum {
        ...
        RuleBlock = 5,
        RuleStatement = 6,
        RuleStatementWithoutAssignment = 7,
        RuleEmpty = 8,
        RuleIfBlock = 9,
        RuleElseBlock = 10,
        RuleWhileBlock = 11,
        RuleRet = 12,
        RuleDeclaration = 13,
        RuleRawDeclaration = 14,
        RuleExpAssignment = 15,
        RuleAssignment = 16,
        RuleExpression = 17
    };
    ...
    public:
        FunctionContext(antlr4::ParserRuleContext *parent,
    ...
    public:
        ParametersContext(antlr4::ParserRuleContext *parent,
                          size_t invokingState);
    ...
    public:
        ParameterContext(antlr4::ParserRuleContext *parent,
                         size_t invokingState);
    ...
    public:
        StatementWithoutAssignmentContext(antlr4::ParserRuleContext *parent,
                                          size_t invokingState);
    ...
    public:
        ElseBlockContext(antlr4::ParserRuleContext *parent,
                         size_t invokingState);
    ...
    public:
        WhileBlockContext(antlr4::ParserRuleContext *parent,
                          size_t invokingState);
    ...
    public:
        DeclarationContext(antlr4::ParserRuleContext *parent,
                           size_t invokingState);
    ...
    public:
        RawDeclarationContext(antlr4::ParserRuleContext *parent,
                              size_t invokingState);
    ...
    class ExpAssignmentContext : public antlr4::ParserRuleContext {
    public:
        ExpAssignmentContext(antlr4::ParserRuleContext *parent,
                             size_t invokingState);
