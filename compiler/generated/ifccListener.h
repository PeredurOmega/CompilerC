...
public:
  ...
  virtual void enterFunctionDeclaration(ifccParser::FunctionDeclarationContext *ctx) = 0;
  virtual void exitFunctionDeclaration(ifccParser::FunctionDeclarationContext *ctx) = 0;

  virtual void enterStaticVariable(ifccParser::StaticVariableContext *ctx) = 0;
  virtual void exitStaticVariable(ifccParser::StaticVariableContext *ctx) = 0;
  ...
  virtual void enterArguments(ifccParser::ArgumentsContext *ctx) = 0;
  virtual void exitArguments(ifccParser::ArgumentsContext *ctx) = 0;

  virtual void enterArgument(ifccParser::ArgumentContext *ctx) = 0;
  virtual void exitArgument(ifccParser::ArgumentContext *ctx) = 0;
  ...
  virtual void enterWhileBlock(ifccParser::WhileBlockContext *ctx) = 0;
  virtual void exitWhileBlock(ifccParser::WhileBlockContext *ctx) = 0;
  ...
  virtual void enterExp(ifccParser::ExpContext *ctx) = 0;
  virtual void exitExp(ifccParser::ExpContext *ctx) = 0;
  ...
  virtual void enterFunctionCall(ifccParser::FunctionCallContext *ctx) = 0;
  virtual void exitFunctionCall(ifccParser::FunctionCallContext *ctx) = 0;
