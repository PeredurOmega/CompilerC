...
public:
    ...
    virtual void enterStatementWithoutAssignment(
            ifccParser::StatementWithoutAssignmentContext *ctx) = 0;
    ...
    virtual void
    enterRawDeclaration(ifccParser::RawDeclarationContext *ctx) = 0;
    ...
    virtual void
    enterTimesDivModulo(ifccParser::TimesDivModuloContext *ctx) = 0;
