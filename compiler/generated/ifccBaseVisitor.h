...
public:
    ...
    virtual std::any
    visitParameters(ifccParser::ParametersContext *ctx) override {
        return visitChildren(ctx);
    }

    virtual std::any
    visitParameter(ifccParser::ParameterContext *ctx) override {
        return visitChildren(ctx);
    }
    ...
    virtual std::any
    visitStatement(ifccParser::StatementContext *ctx) override {
        return visitChildren(ctx);
    }
    ...
    virtual std::any
    visitElseBlock(ifccParser::ElseBlockContext *ctx) override {
        return visitChildren(ctx);
    }

    virtual std::any
    visitWhileBlock(ifccParser::WhileBlockContext *ctx) override {
        return visitChildren(ctx);
    }
    ...
    virtual std::any
    visitBitwiseXor(ifccParser::BitwiseXorContext *ctx) override {
        return visitChildren(ctx);
    }

    virtual std::any
    visitLogicalAnd(ifccParser::LogicalAndContext *ctx) override {
        return visitChildren(ctx);
    }
    ...
    virtual std::any
    visitBitwiseAnd(ifccParser::BitwiseAndContext *ctx) override {
        return visitChildren(ctx);
    }
    ...
    virtual std::any
    visitBitwiseOr(ifccParser::BitwiseOrContext *ctx) override {
        return visitChildren(ctx);
    }

    virtual std::any
    visitLogicalOr(ifccParser::LogicalOrContext *ctx) override {
        return visitChildren(ctx);
    }
